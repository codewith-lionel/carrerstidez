...
exports.applyToJob = async (req, res, next) => {
  try {
    ...
    // Use existing resume from user profile or a placeholder
    let resumeUrl = req.user.resume?.url || "Resume on file";
    let resumePublicId = req.user.resume?.publicId || "";

    // For now, we'll just track that they applied without requiring file upload
