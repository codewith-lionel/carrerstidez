...
exports.sendApplicationConfirmation = async (
  email,
  name,
  jobTitle,
  companyName,
...
exports.sendStatusUpdateEmail = async (email, name, jobTitle, status) => {
  try {
    const statusMessages = {
      ...
      interviewed:
        "You have been invited for an interview. The recruiter will contact you shortly.",
    ...
    console.log("Failed to send status update email:", error.message);
  }
};
